	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul id="active" class="nav navbar-nav side-nav">
				<li>
					<a href="../index.php">
						<i class="fa fa-bullseye"></i> Home</a>
				</li>
				<li>
					<a href="addFilm.php">
					<i class="fa fa-plus"></i></i> Up Phim</a>
				</li>
				<li>
					<a href="addEpisode.php">
					<i class="fa fa-plus"></i></i> Up Video Phim</a>
				</li>
				<li>
				...
				<li>
					<a href="addUser.php">
						<i class="fa fa-user-plus"></i> Thêm Tài Khoản Người Dùng</a>
				</li>
				<li>
					<a href="manageUser.php">
						<i class="fa fa-edit"></i> Quản Lý Tài Khoản Người Dùng</a>
				</li>
			</ul>
